-- Analyze which names were NOT found
...
SELECT
  sn.search_name AS "Name Not Found"
FROM search_names sn
LEFT JOIN contact_matches cm ON cm.search_name = sn.search_name
WHERE cm.id IS NULL
ORDER BY sn.search_name;
