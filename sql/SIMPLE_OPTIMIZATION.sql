-- ============================================================================
-- SIMPLE DATABASE OPTIMIZATION - Copy and run this in Supabase SQL Editor
-- ============================================================================
...
-- Create simple health check view
...
-- Verify it worked
SELECT 'Optimization Complete!' as status, * FROM v_system_health;
